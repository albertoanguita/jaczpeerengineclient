...
public class BuildData {
    ...
    public static void main(String[] args) throws Exception {
        ...
        JPeerEngineClient jPeerEngineClient = SessionManager.load(path, new SimpleJacuzziPeerClientAction(""));
        jPeerEngineClient.addFriendPeer(new PeerID("pid{0000000000000000000000000000000000000000002}"));
        jPeerEngineClient.addFriendPeer(new PeerID("pid{0000000000000000000000000000000000000000003}"));
        ...
        FileIO.writeFileHashDatabase(path, data.element1);
        FileReaderWriter.writeObject(FileUtil.joinPaths(path + "/databases/integrated", "itemsToLocalItems.bin"), data.element2);
        jPeerEngineClient = SessionManager.load(path, new SimpleJacuzziPeerClientAction(""));
        jPeerEngineClient.addFriendPeer(new PeerID("pid{0000000000000000000000000000000000000000001}"));
        jPeerEngineClient.stop();
        SessionManager.save(jPeerEngineClient);
