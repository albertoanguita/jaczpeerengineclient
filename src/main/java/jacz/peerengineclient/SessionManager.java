...
public class SessionManager {
    ...
    public static synchronized Duple<String, PeerId> createUserConfig(String basePath, byte[] randomBytes, String nick, CountryCode mainCountry, String customStorageVersion) throws IOException {
        ...
        try {
            ...
            // custom storage
            VersionedLocalStorage customStorage = VersionedLocalStorage.createNew(PathConstants.customStorage(userPath), customStorageVersion);
            PeerEngineClient.saveApiVersions(customStorage);
