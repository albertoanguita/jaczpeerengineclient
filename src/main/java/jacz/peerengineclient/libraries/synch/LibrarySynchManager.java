...
public class LibrarySynchManager {
     ...
     */
    public LibraryAccessor requestForSharedLibrarySynch(PeerID peerID) throws AccessorNotFoundException, ServerBusyException {
        synchronized (activeSharedSynchs) {
            if (activeSharedSynchs.contains(peerID) ||
                ...
                return new LibraryAccessor(this, sharedLibraryPath, new LibrarySynchProgress(this, LibrarySynchProgress.Mode.SHARED, peerID));
            }
        }
    }
