...
public class LibraryManagerIO {
    ...
    private final static String INTEGRATED_PATH = "integrated.db";
    ...
    private final static String LOCAL_PATH = "local.db";

    private final static String LOCAL_ITEMS_TO_INTEGRATED_ITEMS = "itemsToIntegratedItems.bin";

    private final static String REMOTE_PATH = "remote.db";
