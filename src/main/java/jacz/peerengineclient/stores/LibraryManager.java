...
public class LibraryManager {
     ...
     */
    private jacz.peerengineclient.stores.store_images.IntegratedDatabase integratedDatabase;

    /**
     * The local database, with items created by the user
     */
    private jacz.peerengineclient.stores.store_images.LocalDatabase localDatabase;

    /**
     * The remote databases, with libraries shared to us by friend peers
     */
    private Map<PeerID, jacz.peerengineclient.stores.store_images.RemoteDatabase> remoteDatabases;
    ...
    jacz.peerengineclient.stores.store_images.IntegratedDatabase getIntegratedDatabase() {
        return integratedDatabase;
    }

    jacz.peerengineclient.stores.store_images.LocalDatabase getLocalDatabase() {
        return localDatabase;
    }

    Map<PeerID, jacz.peerengineclient.stores.store_images.RemoteDatabase> getRemoteDatabases() {
