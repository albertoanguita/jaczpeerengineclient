...
/**
 * A list accessor implementation that handles a list of resource identifiers
 */
public class ResourceListAccessor {
//
//    /**
//     * File hash database that gives access to the resources of this accessor
//     */
...
//
//    private int levelForMetadata;
////
////    private final FileHashDatabase fileHashDatabase;
////
//    private final String baseDir;
//
//    protected ResourceListAccessor(Map<String, Integer> identifierListAndPosition, Database database, LibraryManager libraryManager, PeerID remotePeerID, int levelForMetadata, FileHashDatabase fileHashDatabase, String baseDir) {
