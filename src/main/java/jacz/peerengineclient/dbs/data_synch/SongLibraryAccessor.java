 ...
 * Accessor for songs
 */
public class SongLibraryAccessor extends CreationLibraryAccessor {

    public static int LEVEL_FOR_SONG_DATA = 0;

    public static int LEVEL_FOR_REDUCED_IMAGES = 1;

    public static int LEVEL_FOR_MAIN_IMAGES = 2;

    public SongLibraryAccessor(Database database, FileHashDatabase fileHashDatabase, LibraryManager libraryManager, ItemLockManager itemLockManager, PeerID remotePeerID, IntegratedDatabase integratedDatabase, String baseDir) {
        super(database, Libraries.SONG_LIBRARY, fileHashDatabase, libraryManager, itemLockManager, LEVEL_FOR_SONG_DATA, LEVEL_FOR_REDUCED_IMAGES, remotePeerID, integratedDatabase, baseDir);
    }
    ...
    public static int getFieldLevel(String field) {
        switch (field) {
            ...
            default:
                return LEVEL_FOR_SONG_DATA;
        }
    }

    public static List<Integer> getAllLevels() {
        List<Integer> levels = new ArrayList<>();
        levels.add(LEVEL_FOR_SONG_DATA);
