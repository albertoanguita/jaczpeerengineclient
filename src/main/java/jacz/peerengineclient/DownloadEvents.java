...
public interface DownloadEvents {
     ...
     */
    void started(String resourceID, String storeName, DownloadManager downloadManager, DownloadInfo downloadInfo);
     ...
     */
    void resourceSize(String resourceID, String storeName, DownloadManager downloadManager, long resourceSize, DownloadInfo downloadInfo);
     ...
     * @param downloadManager    download manager associated to this download
     */
    void providerAdded(String resourceID, String storeName, ProviderStatistics providerStatistics, DownloadManager downloadManager, PeerID provider, DownloadInfo downloadInfo);
     ...
     * @param downloadManager    download manager associated to this download
     */
    void providerRemoved(String resourceID, String storeName, ProviderStatistics providerStatistics, DownloadManager downloadManager, PeerID provider, DownloadInfo downloadInfo);
     ...
     */
    void providerReportedSharedPart(String resourceID, String storeName, ProviderStatistics providerStatistics, DownloadManager downloadManager, ResourcePart sharedPart, DownloadInfo downloadInfo);
     ...
     */
    void providerWasAssignedSegment(String resourceID, String storeName, ProviderStatistics providerStatistics, DownloadManager downloadManager, LongRange assignedSegment, DownloadInfo downloadInfo);
     ...
     * @param downloadManager    download manager associated to this download
     */
    void providerWasClearedAssignation(String resourceID, String storeName, ProviderStatistics providerStatistics, DownloadManager downloadManager, DownloadInfo downloadInfo);
     ...
     * @param downloadManager download manager associated to this download
     */
    void paused(String resourceID, String storeName, DownloadManager downloadManager, DownloadInfo downloadInfo);
     ...
     * @param downloadManager download manager associated to this download
     */
    void resumed(String resourceID, String storeName, DownloadManager downloadManager, DownloadInfo downloadInfo);
     ...
     * @param downloadManager download manager associated to this download
     */
    void downloadedSegment(String resourceID, String storeName, LongRange segment, DownloadManager downloadManager, DownloadInfo downloadInfo);
     ...
     * @param downloadManager download manager associated to this download
     */
    void checkingTotalHash(String resourceID, String storeName, int percentage, DownloadManager downloadManager, DownloadInfo downloadInfo);
     ...
     * @param downloadManager download manager associated to this download
     */
    void successTotalHash(String resourceID, String storeName, DownloadManager downloadManager, DownloadInfo downloadInfo);
     ...
     * @param downloadManager download manager associated to this download
     */
    void failedTotalHash(String resourceID, String storeName, DownloadManager downloadManager, DownloadInfo downloadInfo);
     ...
     * @param downloadManager download manager associated to this download
     */
    void invalidTotalHashAlgorithm(String resourceID, String storeName, String hashAlgorithm, DownloadManager downloadManager, DownloadInfo downloadInfo);
     ...
     * @param downloadInfo    info about this download
     */
    void cancelled(String resourceID, String storeName, DownloadProgressNotificationHandler.CancellationReason reason, DownloadManager downloadManager, DownloadInfo downloadInfo);
     ...
     * @param downloadInfo    info about this download
     */
    void stopped(String resourceID, String storeName, DownloadManager downloadManager, DownloadInfo downloadInfo);
     ...
     * @param downloadInfo    info about this download
     */
    void completed(String resourceID, String storeName, String path, DownloadManager downloadManager, DownloadInfo downloadInfo);
}
